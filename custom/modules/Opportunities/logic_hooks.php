...
$hook_array['before_save'][] = Array(2,"verificar_avaluos","custom/modules/Opportunities/Opportunities_Hook.php","Opportunities_Hook","verificar_avaluos");
$hook_array['before_save'][] = Array(3,"agendar_inspeccion","custom/modules/Opportunities/Opportunities_Hook.php","Opportunities_Hook","agendar_inspeccion");
...
$hook_array['after_save'][] = Array(1,"set_request_month","custom/modules/Opportunities/Opportunities_Hook.php","Opportunities_Hook","set_request_month");
