...
class CB4IN_InvoiceViewList extends ViewList {
	...
	*/
    ...
    { 	
		...
		{		
			$fecha_inicio	= strftime('%Y-%m-%d',$_REQUEST["date_created_1_basic"]);
			$fecha_fin 		= strftime('%Y-%m-%d',$_REQUEST["date_created_2_basic"]);
			
			/*$this->where = "WHERE date_entered BETWEN '$fecha_inicio' AND '$fecha_fin'";
			echo $this->where;*/
		}
